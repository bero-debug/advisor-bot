...
const STOCKS_LIST = [
  {symbol:"2222",name:"أرامكو",sector:"طاقة"},{symbol:"1120",name:"الراجحي",sector:"بنوك"},
  {symbol:"1180",name:"الأهلي",sector:"بنوك"},{symbol:"1150",name:"الإنماء",sector:"بنوك"},
  {symbol:"1010",name:"الرياض",sector:"بنوك"},{symbol:"2010",name:"سابك",sector:"بتروكيماويات"},
  {symbol:"7010",name:"الاتصالات",sector:"اتصالات"},{symbol:"1211",name:"معادن",sector:"تعدين"},
  {symbol:"1302",name:"المتقدمة",sector:"تقنية"},{symbol:"2170",name:"الصناعات الكهربائية",sector:"صناعة"},
  {symbol:"2243",name:"لوبريف",sector:"صناعة"},{symbol:"4003",name:"بن داوود",sector:"تجزئة"},
  {symbol:"4190",name:"جرير",sector:"تجزئة"},{symbol:"4321",name:"سينومي سنترز",sector:"تجزئة"},
  {symbol:"4322",name:"سينومي ريتيل",sector:"تجزئة"},{symbol:"4310",name:"سيرا",sector:"عقارات"},
  {symbol:"4020",name:"دار الأركان",sector:"عقارات"},{symbol:"2380",name:"پترو رابغ",sector:"بتروكيماويات"},
  {symbol:"4200",name:"مجموعة تداول",sector:"مالية"},{symbol:"2350",name:"سافكو",sector:"بتروكيماويات"},
];
...
async function fetchRealPrice(symbol){
  try{const res=await fetch("https://app.sahmk.sa/api/v1/quote/"+symbol+"/",{headers:{"Accept":"application/json"}});if(!res.ok)return null;const d=await res.json();return{price:parseFloat(d.price),change:parseFloat(d.change),changePct:parseFloat(d.change_percent),volume:parseInt(d.volume)||0};}catch{return null;}
}
